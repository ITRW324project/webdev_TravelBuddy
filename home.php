...
<html lang="en">
	...
	<body>
			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-4">
					...
					<div class="card-block">
						<h1>1</h1>
						<h4 class="card-title">Browse destinations world wide</h4>
					</div>
					</div>
				</div>
  			<div class="col-12 col-md-6 col-lg-4">
					...
					<div class="card-block">
						<h1>2</h1>
						<h4 class="card-title">View ratings and plan your trip</h4>
					</div>
					</div>
				</div>
				<div class="col-12 col-md-6 col-lg-4">
					...
					<div class="card-block">
						<h1>3</h1>
						<h4 class="card-title">Rate your own experiences</h4>
					</div>
					</div>
				</div>
			</div>
		...
		<div class="background-grey">
			<div class="container">
				<h3 class="container-heading">What people said about us</h3>
				<div class="row">
					<div class="comment">
